        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-8 space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition ${
                notifications ? "bg-green-600 hover:bg-green-700" : "bg-white/10 hover:bg-white/20"
              }`}
            >
              <Bell size={18} />
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition ${
                emailAlerts ? "bg-green-600 hover:bg-green-700" : "bg-white/10 hover:bg-white/20"
              }`}
            >
              <Mail size={18} />
          ...
          <div className="pt-6 border-t border-white/10">
            <button
              ...
              className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 px-5 py-2 rounded-lg transition"
            >
              <Save size={18} />
              Save Settings
            </button>
